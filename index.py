...
# concert date string in datetime
...
df_main.drop([
    ...
    'DATA INICIAL', 'DATA FINAL', 'PREÇO MÁXIMO DISTRIBUIÇÃO',
    'PREÇO MÍNIMO DISTRIBUIÇÃO', 'DESVIO PADRÃO DISTRIBUIÇÃO',
    'MARGEM MÉDIA REVENDA', 'PREÇO MÍNIMO REVENDA', 'PREÇO MÁXIMO REVENDA',
    'PREÇO MÉDIO DISTRIBUIÇÃO', 'DESVIO PADRÃO REVENDA'
], inplace=True,axis=1)
                    ...
                    dbc.CardBody([
                        ...
                        dbc.Row([
                            dbc.Col([
                                ...
                                html.Legend("DashBord Analytics")
                            ]),
                        ],
                                style={"margin-top": "10px"}),
                        dbc.Row([
                            dbc.Col([
                                dbc.Button("Visite My GitHub", href='https://github.com/dxdiego5',target='_blank')
                            ],style={"margin-top": "10px"}),
                        ]),
                    ])
                ],style=tab_card)
                    ...
                    dbc.CardBody([
                        dbc.Row([
                            dbc.Col([
                                ...
                                dcc.Dropdown(id='select_ano',value=df_main.at[df_main.index[1], 'ANO'],
                                clearable=False,
                                className='dbc',
                                options = [
            ...
            dbc.Col([
                dbc.Card([
                    dbc.CardBody([
                        ...
                        dcc.Graph(
                            id='direct_comparison_graph', config={'displayModeBar':False,'showTips':False}),
        ...
        dbc.Row([
            dbc.Col([
                dbc.Card([
                    ...
                    ], className='g-1', style={'height':'20%', 'justify':'center'})
                ], style=tab_card)
            ])
        ], className='main_row g-2 my-auto')
...
def func(data, toogle):
    ...
    final_df = pd.concat([min, max], axis=1)
